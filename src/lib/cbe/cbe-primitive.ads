...
is
	...
	function Operation   (Obj : Object_Type) return Operation_Type       with Pre => (Valid(Obj));
	...
	procedure Operation   (Obj : in out Object_Type; Value : Operation_Type)       with Pre => (Valid(Obj));
