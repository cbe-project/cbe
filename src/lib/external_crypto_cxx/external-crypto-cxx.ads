...
is
	...
	type CXX_Key_Data_Type is array (0..31) of CXX_Byte_Type with Size => 32 * 8;

	type CXX_Plain_Data_Type  is array (0..4095) of CXX_Byte_Type with Size => 4096 * 8;
	type CXX_Cipher_Data_Type is array (0..4095) of CXX_Byte_Type with Size => 4096 * 8;
	...
	with
		Export,
		Convention    => C,
		External_Name => "_ZN8External6Crypto26_submit_encryption_requestERKN3Cbe7RequestERKNS1_10Block_dataERb";
	...
	with
		Export,
		Convention    => C,
		External_Name => "_ZNK8External6Crypto33peek_completed_encryption_requestEv";
	...
	with
		Export,
		Convention    => C,
		External_Name => "_ZN8External6Crypto19_supply_cipher_dataERKN3Cbe7RequestERNS1_10Block_dataERb";
	...
	with
		Export,
		Convention    => C,
		External_Name => "_ZN8External6Crypto26_submit_decryption_requestERKN3Cbe7RequestERKNS1_10Block_dataERb";
	...
	with
		Export,
		Convention    => C,
		External_Name => "_ZNK8External6Crypto33peek_completed_decryption_requestEv";
	...
	with
		Export,
		Convention    => C,
		External_Name => "_ZN8External6Crypto18_supply_plain_dataERKN3Cbe7RequestERNS1_10Block_dataERb";
